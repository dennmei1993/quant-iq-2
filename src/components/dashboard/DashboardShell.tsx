...
const NAV = [
  ...
  { href: '/dashboard/watchlist', label: 'My Watchlist',   icon: '★',  section: 'My Watchlist',        separator: true  },
  { href: '/dashboard/portfolio', label: 'My Portfolio',   icon: '🗂️', section: 'My Portfolio', separator: false },
