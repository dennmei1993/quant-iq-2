  ...
  return (
    <div style={{ background: "var(--navy2)", border: "1px solid var(--dash-border)", borderRadius: 8, padding: "1rem 1.1rem" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "0.5rem" }}>
        ...
        {a.change_pct != null && (
          <div style={{ fontSize: "0.78rem", color: a.change_pct >= 0 ? "var(--signal-bull)" : "var(--signal-bear)", fontWeight: 600 }}>
      ...
      <div style={{ height: 3, background: "rgba(255,255,255,0.06)", borderRadius: 2, marginBottom: "0.5rem" }}>
        <div style={{ width: `${a.score ?? 0}%`, height: "100%", background: sigColor, borderRadius: 2 }} />
      </div>

      {a.theme_count > 0 && (
        <div style={{ fontSize: "0.65rem", color: "var(--gold)", opacity: 0.6, marginBottom: "0.4rem" }}>
          {a.theme_count} active theme{a.theme_count !== 1 ? 's' : ''} · {(a.max_theme_weight * 100).toFixed(0)}% weight
        </div>
      )}
