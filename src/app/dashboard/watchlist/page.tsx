...
function changeColor(pct: number | null) {
  if (!pct) return 'rgba(232,226,217,0.35)'
...
export default async function WatchlistPage() {
      ...
      <div>
        ...
        <div style={{
          ...
          <div style={{ color: 'rgba(232,226,217,0.18)', fontSize: '0.75rem', marginTop: '0.4rem' }}>
            Browse <Link href="/dashboard/assets" style={{ color: 'var(--gold)', opacity: 0.6, textDecoration: 'none' }}>Asset Screener</Link> or{' '}
            <Link href="/dashboard/themes" style={{ color: 'var(--gold)', opacity: 0.6, textDecoration: 'none' }}>Themes</Link> and click a ticker to add it
          </div>
        </div>
      </div>
    )
  ...
  // Fetch signals + active themes in parallel
    ...
    <div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          {['Ticker', 'Price', 'Change', 'Score', 'Rationale', 'Active Themes', ''].map(h => (
          ...
          return (
            ...
            >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.2rem' }}>
                {sig?.signal && (
                  <span style={{
                    ...
                    background: `${signalColor(sig.signal)}18`,
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.3rem' }}>
                ...
                {themes.length > 3 && (
                  <span style={{ fontSize: '0.6rem', color: 'rgba(232,226,217,0.2)' }}>+{themes.length - 3}</span>
                )}
              </div>
